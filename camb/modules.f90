...
#ifdef AXION1
        omega_eff = CP%InitPower%phiZERO**(-CP%InitPower%paxionf(1))/10.**(CP%InitPower%log10f(1))
        write(*,*) "******************************************************"
        write(*,*) "**************AXION MONODROMY PARAMS******************"
        write(*,*) "******************************************************"
        write(*,'("f                    = ",f9.6)') CP%InitPower%log10f(1)
        write(*,'("delta n_s            = ",f9.6)') CP%InitPower%deltans(1)
        write(*,'("paxion_f             = ",f9.6)') CP%InitPower%paxionf(1)
        write(*,'("phi_end              = ",f9.6)') CP%InitPower%phiEND
        write(*,'("phi_0                = ",f9.6)') CP%InitPower%phiZERO
        write(*,'("paxion               = ",f9.6)') CP%InitPower%p_axion
        write(*,'("N_*                  = ",f9.6)') CP%InitPower%NEfoldStar
        write(*,'("Effective Frequency  = ",f10.6)') omega_eff
        write(*,*) "******************************************************"
        write(*,*) "******************************************************"
        write(*,*) "******************************************************"
...
#endif
#ifdef AXION2
        write(*,'("alpha                = ",f9.6)') CP%InitPower%log10alpha(1)
        write(*,'("delta n_s            = ",f9.6)') CP%InitPower%deltans(1)
#endif
        if (CP%Num_Nu_Massive > 0) then
...
#ifdef AXION1
    subroutine initlval(lSet,max_l,omega)
#else
